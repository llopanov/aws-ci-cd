...
import com.awsbasics.simpleapp.service.LambdaInvokerService;
...
public class ImageController {
    ...
    @Autowired
    public ImageController(ImageService imageService, LambdaInvokerService lambdaInvokerService) {
    ...
    @GetMapping("/invoke")
    public String invokeLambda(@RequestBody String body) {
        return lambdaInvokerService.invokeLambda(body);
    }
}
